...
while True:
    if number1 > number2:
        word = words[number2 - 1: number1]
        print(word)
        break

    else:
        print("The first number must be greater than the second one")
        number2 = int(input("Please enter a number : "))
        word2 = words[number2 - 1: number1]
        print(word2)
print("----------------")
#Question 2:


user_number = int(input("Pleae enter a number between 3-7 : "))
if   3<=user_number and user_number<=7:
   pass
else:
    print("Try again new number : ")
    user_number = int(input("Pleae enter a number between 3-7 : "))
...
for i in range(8):
    ...
    user_number = int(input("Pleae enter a number between 3-7 : "))
    if 3 <= user_number and user_number <= 7:
        continue # or we can use 'pass' method
    else:
        print("Try again new number : ")
        user_number = int(input("Pleae enter a number between 3-7 : "))
    ...
    diffPass = ""
    for i in range(user_number):
        diffPass += random.choice(words) +""
        print(diffPass)

    diffPass = diffPass[::-1]
    print("Password is : ", diffPass)



if user_number <5 :
    shorter.add(diffPass)
...
removedNumber = dict.pop(myNumber)
...
divided = {'Tonyy': 41, 'Rhode': 43, 'Naten': 35}
...
max_Value = max(united_we_stand.values())
min_Value = min(united_we_stand.values())
